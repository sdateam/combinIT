...
RcppExport SEXP _combinIT_mlkmeans(SEXP dataSEXP, SEXP clustersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _combinIT_fastLm(SEXP ySEXP, SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _combinIT_Mfc(SEXP xSEXP, SEXP ySEXP, SEXP blockSEXP, SEXP treatmentSEXP, SEXP blSEXP, SEXP trSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type treatment(treatmentSEXP);
    Rcpp::traits::input_parameter< double >::type bl(blSEXP);
    Rcpp::traits::input_parameter< double >::type tr(trSEXP);
    rcpp_result_gen = Rcpp::wrap(Mfc(x, y, block, treatment, bl, tr));
    return rcpp_result_gen;
END_RCPP
}
// Mfsim
arma::vec Mfsim(int nsim, int bl, int tr, int p);
RcppExport SEXP _combinIT_Mfsim(SEXP nsimSEXP, SEXP blSEXP, SEXP trSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type nsim(nsimSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type tr(trSEXP);
    Rcpp::traits::input_parameter< int >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(Mfsim(nsim, bl, tr, p));
    return rcpp_result_gen;
END_RCPP
}
// picf
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_combinIT_mlkmeans", (DL_FUNC) &_combinIT_mlkmeans, 2},
    {"_combinIT_fastLm", (DL_FUNC) &_combinIT_fastLm, 2},
    {"_combinIT_res", (DL_FUNC) &_combinIT_res, 1},
    {"_combinIT_Bfc", (DL_FUNC) &_combinIT_Bfc, 4},
    {"_combinIT_Bfsim", (DL_FUNC) &_combinIT_Bfsim, 4},
    {"_combinIT_Mfc", (DL_FUNC) &_combinIT_Mfc, 6},
    {"_combinIT_Mfsim", (DL_FUNC) &_combinIT_Mfsim, 4},
